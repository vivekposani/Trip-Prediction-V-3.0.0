...
object Implementation extends App {
  ...
  //    spark.read.option("header", "true").textFile("hdfs://192.168.70.32:9000/vivek/INSIGHT/CSV/Plaza.csv")
  //  }
  ...
  def write(df: DataFrame, date: String) = {
    val folder = "hdfs://192.168.70.32:9000/vivek/PerformanceMatrix/" + date + "/"
